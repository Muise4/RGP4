...
class GaussianInvDynDiffusion(nn.Module):
    ...
    def forward(self, cond, *args, **kwargs):
        return self.conditional_sample(cond=cond, *args, **kwargs)[:,:-cond.shape[1]]
...
#------------------------------------------ training ------------------------------------------#
    ...
    def p_losses(self, x_start, cond, t, returns=None):
        ...
        x_noisy = torch.cat((x_start, cond), dim=-1)
        # 由nosiy预测xstart，
        ...
        if self.predict_epsilon:
            ...
            loss = self.loss_fn(self.sigmoid(x_recon[:,:-cond.shape[1]]), x_start[:,:-cond.shape[1]])
        # return x_recon
        return loss
