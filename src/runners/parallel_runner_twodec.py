...
class ParallelRunner_TWODEC:
    ...
    def run(self, test_mode=False):
        ...
        while True:
            ...
            # 因此在训练过程中得到的始终是由attention动作决定的状态，观测，奖励等等
            # 只有测试的时候会得到diffusion的状态观测奖励
            # 如果想要完全的二次决策的话，那agent就得获得两个观测，状态，奖励了，分别是由att的状态和diffusion决定
